...
const prod_DSE_GET_LICENSE_URL = 'https://k1bs3h70j0.execute-api.eu-west-1.amazonaws.com/prod/licenses/';
const prod_PAYPAL_BUY_NOW_URL = 'https://www.paypal.com/cgi-bin/webscr';
const prod_PAYPAL_NOTIFY_URL = 'https://k1bs3h70j0.execute-api.eu-west-1.amazonaws.com/prod/payments/paypal';
